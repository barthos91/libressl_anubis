...
#define ANUBIS_ENCRYPT	1
#define ANUBIS_DECRYPT	0
 ...
 */ 
#define KEYSIZEB		16 
#define KEY_SIZE_160		20
#define KEY_SIZE_192		24
#define KEY_SIZE_224		28
#define KEY_SIZE_256		32
#define KEY_SIZE_288		36
#define KEY_SIZE_320		40
 ...
 */ 
int NESSIEkeysetup(const unsigned char * const key, 
		    const int bits,
...
void NESSIEencrypt(const unsigned char * const plaintext,
				   unsigned char * const ciphertext,
				   const struct NESSIEstruct * const structpointer);
				   
void NESSIEdecrypt(const unsigned char * const ciphertext, 
				   unsigned char * const plaintext,
				   const struct NESSIEstruct * const structpointer); 
				         
void ANUBIS_cbc_encrypt(const unsigned char *in, unsigned char *out,
    size_t len, const NESSIEstruct *key, unsigned char *ivec, const int enc);
    
const char *ANUBIS_options(void);
